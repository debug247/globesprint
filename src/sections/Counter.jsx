...
function Counter() {
  ...
  return (
    <div className='w-full lg:px-22 px-5 py-10 grid lg:grid-cols-4 grid-cols-2 lg:gap-5 gap-7 justify-between items-start'>
      <div data-aos="zoom-in" data-aos-delay="100" className='flex flex-col justify-center items-center gap-2'>
        ...
        <h1 className='text-black font-semibold text-center'>Happy Travelers</h1>
      </div>
      <div data-aos="zoom-in" data-aos-delay="200" className='flex flex-col justify-center items-center gap-2'>
        ...
        <h1 className='text-black font-semibold text-center'>Top Destinations</h1>
      </div>
      <div data-aos="zoom-in" data-aos-delay="300" className='flex flex-col justify-center items-center gap-2'>
        ...
        <h1 className='text-black font-semibold text-center'>Customer Reviews</h1>
      </div>
      <div data-aos="zoom-in" data-aos-delay="400" className='flex flex-col justify-center items-center gap-2'>
        ...
        <h1 className='text-black font-semibold text-center'>Country Places</h1>
      </div>
    </div>
  )
}
